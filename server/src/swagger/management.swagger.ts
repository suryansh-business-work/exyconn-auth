 ...
 * /v1/api/admin/users:
 *   get:
 *     summary: Get users in the admin's organization
 *     tags: [Admin Management]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *   get:
 *     summary: Get user by ID (organization scope)
 *     tags: [Admin Management]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *   put:
 *     summary: Update user (organization scope)
 *     tags: [Admin Management]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *               $ref: '#/components/schemas/SuccessResponse'
 *       403:
 *         description: Cannot assign god role
 *       404:
 *         description: User not found
 *   delete:
 *     summary: Delete user (organization scope)
 *     tags: [Admin Management]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *   post:
 *     summary: God user login (returns token and user details)
 *     tags: [God Management]
 *     requestBody:
 *       required: true
 *       content:
 ...
 *   get:
 *     summary: Send credentials email to configured God email
 *     tags: [God Management]
 *     responses:
 *       200:
 ...
 *   post:
 *     summary: Upload file(s) to ImageKit
 *     tags: [File Upload]
 *     requestBody:
 *       required: true
 *       content:
